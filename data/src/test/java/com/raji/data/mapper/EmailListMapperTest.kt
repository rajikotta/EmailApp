...
import com.raji.data.dto.list.Payload
...
class EmailListMapperTest {
    ...
    private companion object {
        ...
        private fun testDataWithEmptyInputOutput() =
            Arguments.of(emptyList<EmailListItemDto>(), emptyList<EmailListItemModel>())

        private fun testDataWithNullId() =
            Arguments.of(listOf(getEmailListItemDto()), emptyList<EmailListItemModel>())
